...
*/
const reducer = (accumulator, currentValue) => accumulator + currentValue;  // Handy-dandy MDN reduce helper function
const populationTotal = []; // Empty array for easy adding and reducing later on
zooAnimals.forEach((element) => populationTotal.push(element.population)); // Loop through root array using forEach, pushing population values into new array
console.log(populationTotal.reduce(reducer)); // Log the total population count for all zoos


/* 
Stretch: If you haven't already, convert your array method callbacks into arrow functions.
*/
// All converted to new (to me) super minimal arrow syntax! 
// Note: I could remove the parantheses from the function parameter when there's only one parameter (and where arrow syntax is used), but that particular 
// piece of syntax helps me recognize the following string as a function, still.
